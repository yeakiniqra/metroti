...
// Check if user is already logged in or not
 ...
 const updateUserData = async (userId) => {
    ...
    if (docSnap.exists()) {
        ...
        setUser({ ...user, username: data.username, contact: data.contact, rapidpass: data.rapidpass, userId: data.userId });
    } else {
...
// Register User
    const register = async (email, password, username, contact, rapidpass) => {
